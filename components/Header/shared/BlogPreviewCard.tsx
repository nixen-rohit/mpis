...
export function BlogPreviewCard({ card }: { card: BlogCard }) {
  ...
  return (
    <div className="flex h-full flex-col gap-2.5">
      ...
      >
        {/* Illustration */}
        <div className="relative h-28 overflow-hidden bg-linear-to-br from-slate-50 via-blue-50 to-indigo-100 shrink-0">
          <svg
          ...
          >
            ...
            <path
              ...
              opacity="0.14"
            />
            <circle cx="180" cy="26" r="36" fill="#60a5fa" opacity="0.12" />
            <circle cx="40" cy="18" r="22" fill="#818cf8" opacity="0.10" />
          </svg>
