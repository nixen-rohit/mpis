...
const allIndustries: IndustryItem[] = [
  {
    ...
    name: "Healthcare",
    imageUrl:
      "https://images.unsplash.com/photo-1584515933487-78021c4631b4?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "2",
    name: "Education",
    imageUrl:
      "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "3",
    name: "Retail",
    imageUrl:
      "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "4",
    name: "Real Estate",
    imageUrl:
      "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "5",
    name: "Manufacturing",
    imageUrl:
      "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "6",
    name: "Finance",
    imageUrl:
      "https://images.unsplash.com/photo-1559526324-4b87b5e36e44?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "7",
    name: "Logistics",
    imageUrl:
      "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "8",
    name: "E-Commerce",
    imageUrl:
      "https://images.unsplash.com/photo-1511556532299-8f662fc26c06?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "9",
    name: "Startups",
    imageUrl:
      "https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&q=80&w=80&h=80",
  },
  {
    id: "10",
    name: "Enterprises",
    imageUrl:
      "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=80&h=80",
  },
];
...
function MarqueeRow({
  ...
  return (
    <div className="relative w-full overflow-hidden">
      <motion.div animate={controls} className="flex gap-4 w-max py-2">
        {duplicated.map((item, i) => (
          ...
          >
            <CapsuleCard item={item} onToggle={() => {}} />
          </motion.div>
        ))}
      </motion.div>
      {/* Left Fade */}
...
export default function IndustryMarquee() {
  ...
  // Tablet/Desktop: same Ubg-linear-to-tr from-[#f3f8fa] via-[#fffdf9] to-[#fffbf2] ues naturally
