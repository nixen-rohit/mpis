...
const plans: PricingPlan[] = [
  {
    ...
    falseFeatures: ["Dedicated project manager", "Custom analytics dashboard"],
      ...
      <div className="max-w-6xl w-full">
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          <p className="mt-5 max-w-2xl mx-auto text-sm sm:text-base leading-relaxed text-zinc-400">
            Flexible engagement models designed for startups, growing teams, and
            enterprises.
          </p>
        </div>
          ...
          {plans.map((plan, index) => (
            ...
            >
              <div>
                ...
                <hr
                  className={`border-t mb-8 ${plan.isPopular ? "border-white/10" : "border-gray-300"}`}
                />
                ...
                <ul className="space-y-4 mb-10">
                  ...
                  {plan.trueFeatures.map((feature, fIdx) => (
                    ...
                    >
                      <div
                        className={`shrink-0 rounded-lg p-0.5 mt-0.5 flex items-center justify-center h-5 w-5 transition-all duration-300 group-hover:scale-110  ${
                          plan.isPopular
                  ...
                  {plan.falseFeatures?.map((feature, fIdx) => (
                    ...
                    >
                      <div className="shrink-0 rounded-lg p-0.5 mt-0.5 flex items-center justify-center h-5 w-5 bg-red-300 text-red-500 ">
